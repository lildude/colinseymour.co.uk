...
task :deploy do
  ...
  ok_failed(system("rsync --compress --recursive --checksum --delete --itemize-changes --iconv=utf-8-mac,utf-8 _site/ do1:www/static-sites/colinseymour/")) # Requires rsync 3 on the Mac.
